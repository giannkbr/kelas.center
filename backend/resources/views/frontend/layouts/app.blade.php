        ...
        <div class="px-4 py-5 text-center container">
            <div class="my-5">
                ...
                <div class="col-lg-6 mx-auto">
                    <p class="lead mb-4 text-white">Semua solusi untuk mempermudah Training dan Upskilling karyawan di
                        perusahaan Anda</p>
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        <button type="button" class="btn btn-primary-kelas btn-lg px-4 gap-3 btn-sm-w-100">Ajukan
                            Demo</button>
                    </div>
                </div>
            </div>
            ...
            <div class="my-5 container">
                ...
                <div class="scroll-container">
                    <div class="scroll-wrapper">
                        <div class="scroll-item"><img src="{{ asset('assets/frontend/img/partner/partner-ieg.png') }}"
                                class="partner-logo" alt="IEG Logo" /></div>
                        <div class="scroll-item"><img src="{{ asset('assets/frontend/img/partner/partner-iep.png') }}"
                                class="partner-logo" alt="IEP Logo" /></div>
                        <div class="scroll-item"><img src="{{ asset('assets/frontend/img/partner/partner-sctv.png') }}"
                                class="partner-logo" alt="SCTV Logo" /></div>
                        <div class="scroll-item"><img src="{{ asset('assets/frontend/img/partner/partner-emtek.png') }}"
                                class="partner-logo" alt="EMTEK Logo" /></div>
                        <div class="scroll-item"><img
                                src="{{ asset('assets/frontend/img/partner/partner-sicepat.png') }}"
                                class="partner-logo" alt="SICEPAT Logo" /></div>
                        <div class="scroll-item"><img
                                src="{{ asset('assets/frontend/img/partner/partner-cloudhost.png') }}"
                                class="partner-logo" alt="Cloudhost Logo" /></div>
                        <div class="scroll-item"><img
                                src="{{ asset('assets/frontend/img/partner/partner-adirect.png') }}"
                                class="partner-logo" alt="Adirect Logo" /></div>
                        <div class="scroll-item"><img src="{{ asset('assets/frontend/img/partner/partner-volta.png') }}"
                                class="partner-logo" alt="Volta Logo" /></div>
                    </div>
                </div>
    ...
    <section class="benefits">
        <div class="px-4 py-5 my-5 text-center container">
            ...
            <div class="col-lg-8 mx-auto">
                <p class="lead mb-4">Kami menghadirkan platform pembelajaran yang komprehensif untuk memberdayakan
                    karyawan Anda. Tingkatkan produktivitas dan efisiensi tim dengan Kelas Center.</p>
                <div
                    class="mt-5 mt-lg-2 d-flex gap-3 flex-nowrap overflow-auto justify-content-center button-container">
                    @foreach($categoryBenefits as $category)
                    <button class="btn btn-outline-kelas"
                        data-target="{{ $category->name }}">{{ $category->name }}</button>
                    @endforeach
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row text-start benefit-section">
                ...
                <div class="col-md-12 benefit-content" id="{{ $benefit->category->name }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="bg-light py-2">
                                <div class="d-flex" style="line-height: 32px"><i class="bi bi-check-lg mx-2"
                                        style="font-size: 2rem"></i> {{ $benefit->benefits }}</div>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="bg-light py-2">
                                <video src="{{ $benefit->url }}" controls style="height: 400px; width: 100%"></video>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="py-5 my-5 text-center">
            <div class="container">
                    ...
                    <div class="col-md-4 col-scroll col-10">
                        <div class="card my-3 bg-light rounded-2">
                            <div class="card-body card-kenapa">
                                ...
                                <div>
                                    <div class="my-3"><i class="bi bi-check-circle-fill mr-2"></i> LMS + kelas by
                                        Kelas.Center</div>
                                    <div class="my-3"><i class="bi bi-check-circle-fill mr-2"></i> Up to 5 Users</div>
                                    <div class="my-3"><i class="bi bi-check-circle-fill mr-2"></i> No charge per user
                                    </div>
                                    <div class="my-3"><i class="bi bi-check-circle-fill mr-2"></i> LMS + kelas by
                                        Kelas.Center</div>
                                    <div class="my-3"><i class="bi bi-check-circle-fill mr-2"></i> Up to 5 Users</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div
                            class="card d-flex align-items-center justify-content-between flex-column flex-md-row rounded-bottom-4 mt-3 bg-kenapa-kelas-center">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    ...
                                    <div class="d-md-flex text-start text-white">
                                        <div class="my-3 mx-md-3" style="margin-left: auto"><i
                                                class="bi bi-check-circle-fill mr-2"></i> >100 users</div>
                                        <div class="my-3 mx-md-3"><i class="bi bi-check-circle-fill mr-2"></i> All
                                            Access Class</div>
                                        <div class="my-3 mx-md-3"><i class="bi bi-check-circle-fill mr-2"></i> More
                                            Features</div>
                                    </div>
        ...
        <div class="px-4 py-5 container">
            ...
            <div class="col-lg-10 mx-auto">
                <p class="lead mb-4 text-center">
                    Kami juga sudah menyediakan banyak pelatihan yang beragam, pelatihan disusun dan dibuat oleh tim
                    kurikulum profesional bersama tim video profesional untuk menghasilkan video dengan
                    kualitas tinggi.
                </p>
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-4">
                    @foreach($categoryKelas as $category)
                    <button id="btn{{ $category->name }}" type="button"
                        class="btn btn-outline-kelas btn-lg px-4 gap-3">{{ $category->name }}</button>
                    @endforeach
                </div>
                ...
                <div id="carouselKelasCom" class="carousel slide py-5 video-section" data-bs-ride="carousel">
                                ...
                                <div class="col-6 col-md-4 mt-3 mt-md-0">
                                    <div class="card">
                                        <div style="position: relative">
                                            <img src="{{ asset('assets/frontend/img/' . $kelas->thumbnail) }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle mt-3 mb-2 text-body-secondary">
                                                {{ $kelas->profession }}</h6>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselKelasCom"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselKelasCom"
                        data-bs-slide="next">
                ...
                <div id="carouselKelasWork" class="carousel slide py-5 d-none video-section" data-bs-ride="carousel">
                </div>
                <div id="carouselBootcamp" class="carousel slide py-5 d-none video-section" data-bs-ride="carousel">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-container">
        <div class="px-4 py-5 text-center cta">
            <div class="py-5 container">
                ...
                <div class="col-lg-6 mx-auto">
                    <p class="lead mb-4">Kami ingin membantu dan menunjukkan kepada Anda bagaimana Kelas corp dapat
                        membantu dalam mengelola pelatihan dan membuat prosesnya lebih cepat dan lebih mudah.</p>
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        <button type="button" class="btn btn-primary-kelas btn-lg px-4 gap-3 btn-sm-w-100">Ajukan
                            Demo</button>
                    </div>
        ...
        <div class="bg-dark py-5">
            <div class="container">
                <div class="row text-white">
                    <div class="col-md-3">
                        <img class="d-block mb-3" src="{{ asset('assets/frontend/img/logo/logo-white.png') }}"
                    ...
                    <div class="col-md-3 mt-5 mt-md-0">
                        ...
                        <p><i class="bi bi-envelope"></i> <a href="mailto:nabilla.anggraini@kelas.com"
                                class="text-white">Nabilla.Anggraini@kelas.com</a></p>
